  ...
  return (
    ...
    >
      ...
      {centerValue !== '100' && (
        ...
        >
        <span className={`text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight transition-colors duration-200 ${isHovered ? 'text-blue-600' : 'text-gray-800'}`}>
          {centerValue || Math.round(totalPercentage)}
        </span>
        <span className={`text-lg sm:text-xl md:text-2xl font-bold ml-1 tracking-tight transition-colors duration-200 ${isHovered ? 'text-blue-600' : 'text-gray-800'}`}>
          %
        </span>
        </div>
      )}
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="text-center">
          ...
          <div 
            className="text-xs sm:text-sm font-bold text-gray-800 leading-none"
          ...
          >
            ...
            {centerSubLabel && (
              <>
                <br />
                <span className="text-xs sm:text-xs text-gray-700 font-normal">{centerSubLabel}</span>
              </>
            )}
          </div>
        </div>
